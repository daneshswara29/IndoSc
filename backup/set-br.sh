...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/daneshswara29/IndoSc/main/backup/rclone.conf"
...
wget -O limitspeed "https://raw.githubusercontent.com/daneshswara29/IndoSc/main/backup/limitspeed.sh"
chmod +x autobackup
chmod +x backup
chmod +x restore
chmod +x strt

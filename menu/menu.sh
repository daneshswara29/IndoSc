...
echo -e "${BIYellow}□ TELEGRAM            = ${IPurple}{ ${BIWhite}@bijiOntaTerbangG ${IPurple}}${NC}"
echo -e "${BIYellow}□ AutoScript By       = ${IPurple}( ${BICyan}CorpIDR2${BIYellow}VPN ${IPurple})${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}CorpIDR2 ${BIYellow}VPN ${NC}"
echo -e "${BICyan} | ${NC}"

...
Exp=$(curl -sS https://raw.githubusercontent.com/daneshswara29/IP/main/vps | grep $MYIP | awk '{print $3}')
fi
...
Exp1=$(curl https://raw.githubusercontent.com/daneshswara29/IP/main/vps | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"

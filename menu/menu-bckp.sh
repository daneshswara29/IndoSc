...
LLatest=`date`
Get_Data () {
git clone https://github.com/daneshswara29/userbackup.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    cd /root/user-backup
    git config --global user.email "okysmilee@gmail.com" &> /dev/null
    git config --global user.name "daneshswara29" &> /dev/null
    rm -rf .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m $NameUser &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/daneshswara29/userbackup.git
    git push -f https://github.com/daneshswara29/userbackup.git &> /dev/null
}
...
echo -e""
echo -e "$yellow Username :👉  daneshswara29 👈$NC"
echo -e""
echo -e "$yellow PASTEKAN Username GITHUB DI BAWAH INI$NC"
echo -e ""
Save_And_Exit
fi
link="https://raw.githubusercontent.com/daneshswara29/userbackup/main/$NameUser/$NameUser.zip"
sleep 1
...
cekdata=$(curl -sS https://raw.githubusercontent.com/daneshswara29/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
mkdir -p /root/backup
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/daneshswara29/userbackup/main/$NameUser/$NameUser.zip" &> /dev/null
...
echo -e "$COLOR1 ${NC}                ${WH}• CorpIDR2 VPN •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""

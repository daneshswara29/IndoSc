#!/bin/bash
# // font color configuration | CorpIDR2 VPN AUTOSCRIPT
...
====================================================================
             MEMEK DONASI LAH WKWKWK
====================================================================
        https://raw.githubusercontent.com/CorPID0
====================================================================
...
echo -e "\\e[42m    Shadowsocks Account   \E[0m" | tee -a /etc/log-create-user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/log-create-user.log
...
echo -e "033[1;93m───────────────────────────\033[0m" | tee -a /etc/log-create-user.log
echo -e "Link JSON  : https://${domain}:81/ss-$user.txt" | tee -a /etc/log-create-user.log
echo -e "033[1;93m───────────────────────────\033[0m" | tee -a /etc/log-create-user.log
